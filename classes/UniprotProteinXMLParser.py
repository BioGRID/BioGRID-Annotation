...
class UniprotProteinXMLParser( handler.ContentHandler ) :
	...
	def __init__( self, uniprotKB, organismID ) :
		...
		self.ignoreExternal = set( ['GO', 'ALLERGOME','ARRAYEXPRESS','CAZY','CCDS','CHITARS','CLEANEX','COMPLUYEAST-2DPAGE','DISPROT','DMDM','GENE3D','GENECARDS','GENEREVIEWS','GENEFARM','GENEWIKI','GENOLIST','GENOMERNAI','GRAMENE','GUIDETOPHARMACOLOGY','H-INVDB','HAMAP','HOGENOM','HOVERGEN','HPA','MAXQB','MEROPS','MYCOCLAP','NEXTPROT','OGP','ORPHANET','PATRIC','PAXDB','PEPTIDEATLAS','PEROXIBASE','PHARMGKB','PHOSPHOSITE','PHOSSITE','PMAP-CUTDB','PPTASEDB','PROMEX','PROTEINMODELPORTAL','REBASE','REPRODUCTION-2DPAGE','SABIO-RK','SIGNALINK','SWISS-2DPAGE','TCDB','TIGRFAMS','UCD-2DPAGE','TREEFAM','UCSC','UNICARBKB','UNIPATHWAY','WORLD-2DPAGE','DNASU', 'DOSAC-COBS-2DPAGE','PFAM','INTACT','DIP','GENEID','STRING','MINT','SMART','SUPFAM','EMBL','GENEVESTIGATOR','GENETREE'] )
